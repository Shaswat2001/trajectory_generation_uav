...
from rl_aerial_manipulation.environment.GazeboEnv.Quadrotor.BaseGazeboUAVVelObsEnvPCD import BaseGazeboUAVVelObsEnv1PCD
...
if __name__=="__main__":
    ...
    elif "uav_vel_obs_gazebo1_pcd" == args.Environment:
        env = BaseGazeboUAVVelObsEnv1PCD()
