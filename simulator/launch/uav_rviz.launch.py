...
def generate_launch_description():
    ...
    base_rviz_sim = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([FindPackageShare('simulator'), '/launch', '/rviz.launch.py']),
        launch_arguments={
        }.items(),
        )
    ...
    package_name = 'uamv0'
    robot_name_in_model = 'rmaluam'
    sdf_model_path = 'models/rmaluam/uav_lidar.sdf'
    # world_file_path = 'worlds/empty.world'
    world_file_path = 'worlds/small_warehouse.world'
